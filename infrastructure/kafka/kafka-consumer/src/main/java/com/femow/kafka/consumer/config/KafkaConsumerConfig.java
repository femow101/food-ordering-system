package com.femow.kafka.consumer.config;

import com.femow.kafka.config.data.KafkaConfigData;
import com.femow.kafka.config.data.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public Map<String, Object> consumerConfigs() {
        Map<String, Object> props = new java.util.HashMap<>(Map.of(
                ...
                ConsumerConfig.MAX_PARTITION_FETCH_BYTES_CONFIG, kafkaConsumerConfigData.getMaxPartitionFetchBytesDefault()
