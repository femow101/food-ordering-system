package com.femow.order.service.dataaccess.order.mapper;

import com.femow.domain.valueobject.*;
import com.femow.order.service.dataaccess.order.entity.OrderAddressEntity;
import com.femow.order.service.dataaccess.order.entity.OrderEntity;
import com.femow.order.service.dataaccess.order.entity.OrderItemEntity;
import com.femow.order.service.domain.entity.Order;
import com.femow.order.service.domain.entity.OrderItem;
...
public class OrderDataAccessMapper {
    ...
    public Order orderEntityToOrder(OrderEntity orderEntity) {
        return Order.builder()
                ...
                .failureMessages(orderEntity.getFailureMessage().isEmpty() ? new ArrayList<>() : new ArrayList<>(
                        Arrays.asList(orderEntity.getFailureMessage().split(Order.FAILURE_MESSAGE_DELIMITER))
                ))
                .build();
    }
