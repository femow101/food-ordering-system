...
import com.femow.kafka.order.avro.model.OrderApprovalStatus;
import com.femow.kafka.order.avro.model.RestaurantApprovalResponseAvroModel;
import com.femow.order.service.domain.entity.Order;
import com.femow.order.service.domain.ports.input.message.listener.restaurantapproval.RestaurantApprovalResponseMessageListener;
    ...
    public void receive(@Payload List<RestaurantApprovalResponseAvroModel> messages,
        ...
        messages.forEach(restaurantApprovalResponseAvroModel -> {
            if (OrderApprovalStatus.APPROVED == restaurantApprovalResponseAvroModel.getOrderApprovalStatus()) {
                ...
                log.info("Processing rejected rorder for order id: {}, with failure messages: {}",
